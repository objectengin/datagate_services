package com.object.datagate.server;
...
public class EmbeddedJetty {
    ...
    private static final String CONTEXT_PATH = "/datagate";
    private static final String CONFIG_LOCATION_PACKAGE = "com.object.datagate.config";
